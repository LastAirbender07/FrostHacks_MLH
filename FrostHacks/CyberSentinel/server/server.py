...
defPath = 'D:\Hackathons\FrostHacks\CyberSentinel\server'
...
def run_csrf(url):
    ...
    output_file = defPath + "\server\output.txt" 
...
BARD_API_KEY = "AIzaSyC8CTkXeWkMi3onMmWzd2XAt8kcf_6IXQQ"
